...
//预计每天凌晨6点定时跑
    //集群存储指标获取后存储在adam集群
public class TestAdamStoreBi {

    private static Logger logger = LoggerFactory.getLogger(TestAdamStoreBi.class);
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        try {
            ...
            Table table = connection.getTable(TableName.valueOf("bi:storedata"));//test:test_hbase_bdp
            table.put(putList);
